...
public class SdxBookTicktController {
	...
	@Consume(TSdxBookTicktVo.class)
	@UrlAuth
	public Response findTSdxBookTickt(@RequestParam(required = false) Integer page, @RequestParam(required = false) Integer size, @RequestParam(required = false) String openResponseExplainFlag, @RequestParam(required = false) Long id, @RequestParam(required = false) Long expire, @RequestParam(required = false) Long userId, Integer isUsed) {
