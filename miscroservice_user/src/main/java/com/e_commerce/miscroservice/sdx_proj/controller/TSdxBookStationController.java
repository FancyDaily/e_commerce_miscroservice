...
public class TSdxBookStationController {
    @Autowired
    private TSdxBookStationService tSdxBookStationService;
    ...
    */
    ...
    public Response modTSdxBookStation(@RequestParam(required = false) Long id,@RequestParam(required = false) String name,@RequestParam(required = false) String address,@RequestParam(required = false) Double latitude,@RequestParam(required = false) Double longitude) {
        ...
        return Response.success(tSdxBookStationService.modTSdxBookStation(tSdxBookStationVo.copyTSdxBookStationPo()));
    }
    ...
    */
    ...
    public Response delTSdxBookStation(Long[] ids) {
        ...
        return Response.success(tSdxBookStationService.delTSdxBookStationByIds(ids));
    }
    ...
    */
    ...
    TSdxBookStationVo tSdxBookStationVo = (TSdxBookStationVo) ConsumeHelper.getObj();
        ...
        if(tSdxBookStationVo.getId()!=null){
            return Response.success(tSdxBookStationService.findTSdxBookStationById(tSdxBookStationVo.getId()));
        }
        return Response.success(tSdxBookStationService.findTSdxBookStationByAll(tSdxBookStationVo.copyTSdxBookStationPo (),page,size), IdUtil.getTotal());
    }
}
