...
public class TSdxInviterController {
    @Autowired
    private TSdxInviterService tSdxInviterService;
    ...
    */
    ...
    public Response modTSdxInviter(@RequestParam(required = false) Long id,@RequestParam(required = false) Long userId,@RequestParam(required = false) Long inviterId,@RequestParam(required = false) Long bookInfoId) {
        ...
        return Response.success(tSdxInviterService.modTSdxInviter(tSdxInviterVo.copyTSdxInviterPo()));
    }
    ...
    */
    ...
    public Response delTSdxInviter(Long[] ids) {
        ...
        return Response.success(tSdxInviterService.delTSdxInviterByIds(ids));
    }
    ...
    */
    ...
    TSdxInviterVo tSdxInviterVo = (TSdxInviterVo) ConsumeHelper.getObj();
        ...
        if(tSdxInviterVo.getId()!=null){
            return Response.success(tSdxInviterService.findTSdxInviterById(tSdxInviterVo.getId()));
        }
        return Response.success(tSdxInviterService.findTSdxInviterByAll(tSdxInviterVo.copyTSdxInviterPo (),page,size), IdUtil.getTotal());
    }
}
