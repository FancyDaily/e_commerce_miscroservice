...
public class TSdxBookOrderController {
    ...
    */
    ...
    public Response delTSdxBookOrder(Long[] ids) {
        ...
        return Response.success(sdxBookOrderService.delTSdxBookOrderByIds(ids));
    }
    ...
    */
    ...
    TSdxBookOrderVo tSdxBookOrderVo = (TSdxBookOrderVo) ConsumeHelper.getObj();
        ...
        if(tSdxBookOrderVo.getId()!=null){
            return Response.success(sdxBookOrderService.findTSdxBookOrderById(tSdxBookOrderVo.getId()));
        }
        return Response.success(sdxBookOrderService.findTSdxBookOrderByAll(tSdxBookOrderVo.copyTSdxBookOrderPo (),page,size), IdUtil.getTotal());
    }
}
