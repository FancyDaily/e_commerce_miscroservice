...
public class TSdxBookInfoUserPreOrderController {
	...
	public Response modTSdxBookInfoUserPreOrder(@RequestParam(required = false) Long id, @RequestParam(required = false) Long userId, @RequestParam(required = false) Long bookInfoId) {
	 ...
	 */
	@RequestMapping("del")
	public Response delTSdxBookInfoUserPreOrder(Long[] ids) {
