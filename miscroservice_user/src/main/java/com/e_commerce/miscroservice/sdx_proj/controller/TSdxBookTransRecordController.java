...
public class TSdxBookTransRecordController {
    @Autowired
    private TSdxBookTransRecordService tSdxBookTransRecordService;
    ...
    */
    ...
    public Response modTSdxBookTransRecord(@RequestParam(required = false) Long id,@RequestParam(required = false) Integer type,@RequestParam(required = false) Long bookId,@RequestParam(required = false) Long userId,@RequestParam(required = false) Long bookInfoId,@RequestParam(required = false) String description) {
        ...
        return Response.success(tSdxBookTransRecordService.modTSdxBookTransRecord(tSdxBookTransRecordVo.copyTSdxBookTransRecordPo()));
    }
    ...
    */
    ...
    public Response delTSdxBookTransRecord(Long[] ids) {
        ...
        return Response.success(tSdxBookTransRecordService.delTSdxBookTransRecordByIds(ids));
    }
    ...
    */
    ...
    TSdxBookTransRecordVo tSdxBookTransRecordVo = (TSdxBookTransRecordVo) ConsumeHelper.getObj();
        ...
        if(tSdxBookTransRecordVo.getId()!=null){
            return Response.success(tSdxBookTransRecordService.findTSdxBookTransRecordById(tSdxBookTransRecordVo.getId()));
        }
        return Response.success(tSdxBookTransRecordService.findTSdxBookTransRecordByAll(tSdxBookTransRecordVo.copyTSdxBookTransRecordPo (),page,size), IdUtil.getTotal());
    }
}
