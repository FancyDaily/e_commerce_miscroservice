...
public class TSdxBookAfterReadingNoteController {
    @Autowired
    private TSdxBookAfterReadingNoteService tSdxBookAfterReadingNoteService;
    ...
    */
    ...
    public Response modTSdxBookAfterReadingNote(@RequestParam(required = false) Long id,@RequestParam(required = false) Long bookId,@RequestParam(required = false) Long userId,@RequestParam(required = false) Long bookInfoId,@RequestParam(required = false) Integer thumbUpNum,@RequestParam(required = false) Integer thumbDownNum) {
        ...
        return Response.success(tSdxBookAfterReadingNoteService.modTSdxBookAfterReadingNote(tSdxBookAfterReadingNoteVo.copyTSdxBookAfterReadingNotePo()));
    }
    ...
    */
    ...
    public Response delTSdxBookAfterReadingNote(Long[] ids) {
        ...
        return Response.success(tSdxBookAfterReadingNoteService.delTSdxBookAfterReadingNoteByIds(ids));
    }
    ...
    */
    ...
    TSdxBookAfterReadingNoteVo tSdxBookAfterReadingNoteVo = (TSdxBookAfterReadingNoteVo) ConsumeHelper.getObj();
        ...
        if(tSdxBookAfterReadingNoteVo.getId()!=null){
            return Response.success(tSdxBookAfterReadingNoteService.findTSdxBookAfterReadingNoteById(tSdxBookAfterReadingNoteVo.getId()));
        }
        return Response.success(tSdxBookAfterReadingNoteService.findTSdxBookAfterReadingNoteByAll(tSdxBookAfterReadingNoteVo.copyTSdxBookAfterReadingNotePo (),page,size), IdUtil.getTotal());
    }
}
