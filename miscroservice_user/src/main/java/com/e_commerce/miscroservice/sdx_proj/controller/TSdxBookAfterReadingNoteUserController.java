...
public class TSdxBookAfterReadingNoteUserController {
    @Autowired
    private TSdxBookAfterReadingNoteUserService tSdxBookAfterReadingNoteUserService;
    ...
    */
    ...
    public Response modTSdxBookAfterReadingNoteUser(@RequestParam(required = false) Long id,@RequestParam(required = false) Integer type,@RequestParam(required = false) Long bookId,@RequestParam(required = false) Long userId,@RequestParam(required = false) Integer isThumb,@RequestParam(required = false) Long bookInfoId,@RequestParam(required = false) Integer isPurchase,@RequestParam(required = false) Long bookAfterReadingNoteId) {
        ...
        return Response.success(tSdxBookAfterReadingNoteUserService.modTSdxBookAfterReadingNoteUser(tSdxBookAfterReadingNoteUserVo.copyTSdxBookAfterReadingNoteUserPo()));
    }
    ...
    */
    ...
    public Response delTSdxBookAfterReadingNoteUser(Long[] ids) {
        ...
        return Response.success(tSdxBookAfterReadingNoteUserService.delTSdxBookAfterReadingNoteUserByIds(ids));
    }
    ...
    */
    ...
    TSdxBookAfterReadingNoteUserVo tSdxBookAfterReadingNoteUserVo = (TSdxBookAfterReadingNoteUserVo) ConsumeHelper.getObj();
        ...
        if(tSdxBookAfterReadingNoteUserVo.getId()!=null){
            return Response.success(tSdxBookAfterReadingNoteUserService.findTSdxBookAfterReadingNoteUserById(tSdxBookAfterReadingNoteUserVo.getId()));
        }
        return Response.success(tSdxBookAfterReadingNoteUserService.findTSdxBookAfterReadingNoteUserByAll(tSdxBookAfterReadingNoteUserVo.copyTSdxBookAfterReadingNoteUserPo (),page,size), IdUtil.getTotal());
    }
}
