...
import com.e_commerce.miscroservice.user.vo.CollectionView;
...
public class TOrder implements Serializable {
    ...
    public TOrder exchangeOrder(com.e_commerce.miscroservice.commons.entity.application.TOrder tOrder) {
        return BeanUtil.copy(tOrder, TOrder.class);
    }

    public StrServiceView copyStrServiceViewByExchange() {
        return null;
    }

    public UserPageServiceVO copyUserPageServiceVO() {
        return null;
    }

    public CollectionView copyCollectionView() {
        return null;
    }

    public SinglePaymentView copySinglePaymentView() {
        SinglePaymentView singlePaymentView = new SinglePaymentView();
        singlePaymentView.setType(String.valueOf(getType()));
        singlePaymentView.setCollectTime(getCollectTime().intValue());
        return null;
    }
}