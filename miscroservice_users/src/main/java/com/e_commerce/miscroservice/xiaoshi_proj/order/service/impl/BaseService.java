...
public class BaseService {
	...
	protected String checkLogin(String uuid, TUser user, String token, boolean opt, Integer applicaiton) {
		...
		if(reg.getToken() != null && !"".equals(reg.getToken())) {
			...
			Token load = authorizeRpcService.load(userNamePrefix + user.getId(), DEFAULT_PASS, uuid); //从认证中心获取
