...
//import com.e_commerce.miscroservice.user.po.TUserFreeze;
//import com.e_commerce.miscroservice.user.po.TUserTimeRecord;
...
//      List<Integer> dailyTaskList = Arrays.asList(dailyTaskArray);
    ...
    public boolean isCareUser(Long userId, Long userFollowId) {
        return userFollowDao.isAtten(userId, userFollowId);
    }
