...
public enum SysMsgEnum {
	RIGESTER("欢迎加入壹晓时","恭喜您成功注册，感恩与您同行，壹晓时在此赠送您30分钟互助时，您可以在您的时间账户中查看。"),
	INVITER("邀请好友奖励","您邀请的名称为%s的好友已注册成功，恭喜您获得30分钟的互助时奖励。"),	//TODO 含参数
	FIRST_HELP("完成首次互助奖励","您已经在「壹晓时」完成首次互助，恭喜您获得30分钟的互助时奖励。期待您"),
	AUTH("实名认证奖励","您也是有身份的人啦，恭喜哦！而且也收获了30分钟的互助时奖励。现在，您可以在「壹晓时」看看有没有需要帮助和帮助到你的小伙伴吧！"),
