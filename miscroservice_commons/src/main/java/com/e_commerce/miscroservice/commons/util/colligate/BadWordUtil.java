 ...
 * 作者:马晓晨
 * 邮箱:747052172
 * 创建时间:2018/10/29 下午4:42
 */
public class BadWordUtil {
//    public static String filePath = BadWordUtil.class.getClassLoader().getResource("badWord.txt").getPath();//敏感词库文件路径
    ...
    static {
        try {
//        	filePath = ResourceUtils.getFile("classpath:badWord.txt");
        	filePath = "/usr/local/timebank_server/badWord.txt";
//            filePath = BadWordUtil.class.getClassLoader().getResource("/usr/local/timebank_server/badWord.txt").toURI().getPath();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
