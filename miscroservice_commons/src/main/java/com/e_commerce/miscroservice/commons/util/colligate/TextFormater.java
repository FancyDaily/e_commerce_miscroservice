...
public class TextFormater {
	...
	public final static String DATE_TIME_PATTERN_SLASH = "yyyy/MM/dd HH:mm";
	...
	public static String format(String date, String pattern) {
		...
		if (pattern.equals(DATE_PATTERN) && date.length() == 8) {
			String dt = date.substring(0, 4) + "-" + date.substring(4, 6) + "-" + date.substring(6, 8);
			return dt;
		}
		if (pattern.equals(DATE_TIME_PATTERN_SLASH) && date.length() == 12) {
			String dt = date.substring(0, 4) + "-" + date.substring(4, 6) + "-" + date.substring(6, 8)
